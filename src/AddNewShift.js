...
$('#fromtimepicker').timepicker({
    ...
    $('#totimepicker').timepicker({ onSelect: function(time) {
...
var self=this;
 $.ajax({
  ...
  to:this.state.to,
  companyId:this.state.companyId, }),
        url: "http://localhost:8080/EmployeeAttendenceAPI/employeeshiftconfig/shiftconfiginsert",
    ...
    if(data.response=="Already Exist"){
      confirmAlert({
                ...
                message:  'Shift'+data.shift+'Already Exist' ,               // Message dialog
